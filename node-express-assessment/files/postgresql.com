...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-05-07T18:45:53.325815" />
 ...
 <div class="container margin">
   ...
   <div class="row">
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kf"> Performance Tips for Developers Using Postgres and pgvector</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kd"> What’s new in Citus 11.3 &amp; Postgres for multi-tenant SaaS workloads</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kb"> Use PostgreSQL® DOMAIN rules to validate columns of data</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Kc"> PGSQL Phriday #008: pg_stat_statements</a></h3>
            <ul class="meta">
